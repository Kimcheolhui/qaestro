...
**Pattern:** Route work by architecture boundary, not by generic frontend or backend labels. **Context:** devclaw is an embedded QA agent platform whose main risks are orchestration, analysis quality, validation trust, and self-hosted operations.
