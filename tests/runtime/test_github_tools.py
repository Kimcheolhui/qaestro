...
class RecordingGitHubClient:
    ...
    def create_pull_request_review(
        ...
        *,
        ...
        self.calls.append(("review", owner, repo, number, body, commit_id, event, comments))
        return ReviewResult(
            id=4242,
            html_url=f"https://github.com/{owner}/{repo}/pull/{number}#pullrequestreview-4242",
            state=event,
            body=body,
        )
...
def test_github_pr_review_tool_posts_official_review_with_inline_comments() -> None:
    client = RecordingGitHubClient()
    runtime = _runtime(client)
    ...
    result = runtime.execute(
        ToolCall(
            ...
            input={
                ...
                "body": "review body",
                "event": "COMMENT",
                "comments": ({"path": "src/app.py", "body": "inline body", "line": 12, "side": "RIGHT"},),
            },
